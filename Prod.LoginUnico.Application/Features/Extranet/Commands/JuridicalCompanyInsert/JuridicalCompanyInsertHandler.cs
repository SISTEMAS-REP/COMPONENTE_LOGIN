...
namespace Prod.LoginUnico.Application.Features.Extranet.Commands.JuridicalCompanyInsert;

public class JuridicalCompanyInsertHandler
    : IRequestHandler<JuridicalCompanyInsertCommand>
{
    ...
    public JuridicalCompanyInsertHandler(
    ...
    public async Task<Unit>
        Handle(JuridicalCompanyInsertCommand request,
