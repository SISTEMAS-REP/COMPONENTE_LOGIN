...
public class GeneralReniecResponse : IMapFrom<(BuscarPersonaResponse, PersonaGeneralResponse)>
{
    ...
    {
        profile.CreateMap<BuscarPersonaResponse, GeneralReniecResponse>()
        ...
        profile.CreateMap<PersonaGeneralResponse, GeneralReniecResponse>()
