...
@Component({
  selector: 'app-register-company-fourth-step',
  templateUrl: './register-company-fourth-step.component.html',
})
export class RegisterCompanyFourthStepComponent implements OnInit {
