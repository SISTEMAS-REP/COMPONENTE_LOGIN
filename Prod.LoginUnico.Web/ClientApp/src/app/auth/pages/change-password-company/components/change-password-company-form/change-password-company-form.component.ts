...
@Component({
  selector: 'app-change-password-company-form',
  templateUrl: './change-password-company-form.component.html'
})
export class ChangePasswordCompanyFormComponent implements OnInit {
