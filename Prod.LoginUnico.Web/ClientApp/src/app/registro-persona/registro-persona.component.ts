...
export class RegistroPersonaComponent implements OnInit {
  ...
  changeContrasena = () => {
    ...
    if (this.contrasena == null || this.contrasena == '') {
      ...
      if (
        this.ValidadorSimbolo &&
        this.ValidadorMayuscula &&
        this.ValidadorNumeros &&
        this.Validador8Digitos
      ) {
        this.validadorRequisitosContrasena = false;
        this.validadorContrasena = false;
      } else {
  ...
  changeTerminos = () => {
    if (
      this.terminos_mensajeria == null ||
      this.terminos_mensajeria == false ||
      this.terminos_politica == null ||
      this.terminos_politica == false
    ) {
  ...
  clickCancelar = () => {
    window.location.href =
      '/sesion-persona?id_aplicacion=' + this.id_aplicacion;
  };
