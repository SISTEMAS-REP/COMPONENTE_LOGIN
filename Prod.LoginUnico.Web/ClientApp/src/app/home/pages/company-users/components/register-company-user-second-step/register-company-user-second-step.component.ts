...
@Component({
  selector: 'app-register-company-user-second-step',
  templateUrl: './register-company-user-second-step.component.html',
  styleUrls: [],
})
export class RegisterCompanyUserSecondStepComponent implements OnInit {
