...
@Component({
  selector: 'app-register-company-user-first-step',
  templateUrl: './register-company-user-first-step.component.html',
  styleUrls: [],
})
export class RegisterCompanyUserFirstStepComponent implements OnInit {
